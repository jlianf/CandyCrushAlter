...
*	
*	@version 	= 2.0.87
*	@lastupdate = 02/01/202022 15:02:55
*	@year		= 2019
*
*	MCE			= Free Code Official
*
...
var X = function () {
	...
	d.addButton(this.root, 550, 60, "pause_btn", function () {
		gradle.event('levelPause', (X.cLevel + 1) );
...
Ob.prototype = z(E.prototype, {
	...
	makeLevelEnd: function (a) {
		...
		}, !1) : (a ? (t.muteSoundtrack(), t.playSfx("game_over_sfx", 0.5), gradle.event('gameOver', this.cLevel, this.cLevelScore)) : t.playSfx("level_end_sfx"), a || (fa.unlockedLevels < this.cLevel + 1 && (fa.unlockedLevels = this.cLevel + 1, fa.saveData()),
			gradle.event('levelUp', this.cLevel + 1, this.cLevelScore)), d.addDelay(this.owner, 1, function () {
			d.pushScene((new qc(b.cLevelScore, a,b.cLevel + 1)).root)
		}, !1));
		if(!a) gradle.event('dp_submitScore', this.cLevelScore,this.cLevel + 1);
	},
	updateScore: function (a) {
		this.cLevelScore += a;
...
var qc = function (a, b,c) {
	...
	if (b) {
		...
		c.centerAnchor();
		c.setAlign(K.Center);
		setTimeout(function(){gradle.event('dp_share')},200);
		...
		d.halfWidth + 150, d.halfHeight + 280, "play_small_btn", function () {
			X.cLevel += 1;
			gradle.event('levelNext',X.cLevel + 1);
	...
	d.addButton(this.root, d.halfWidth + c, d.halfHeight + 280, "replay_btn", function () {
		t.unmuteSoundtrack();
		gradle.event('levelReplay',X.cLevel + 1);
		d.goToScene((new X).root);
	})
...
var wa = function () {
	...
	g = d.addButton(this.root, d.halfWidth - 220, d.height - 140, "more_games_btn", function () {
		gradle.event('clickMore');
	}, "", 1, 0)._compMap.Sprite_0;
	g.alpha.animateTo(1, 1, q.quadOut);
	g.y.animateTo(d.height - 190, 1, q.bounceOut)
	gradle.event('mainScene');
};
